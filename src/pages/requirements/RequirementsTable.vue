        ...
        <div class="col-md-12">
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <input type="text" placeholder="REQ00001" class="form-control" name="reqId" v-model="reqId" @change="setFilters">
                </div>

                <div class="form-group col-md-3">
                    <label for="brand">Brand</label>
                    <select name="brand" id="brand" v-model="brand" class="form-control" @change="setFilters">
